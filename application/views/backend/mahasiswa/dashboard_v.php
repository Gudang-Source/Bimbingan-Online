        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <img src="<?php echo base_url() . 'assets/'; ?>img/head1.png" alt="" class="img-fluid rounded-top">
                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-lg-6">
                                ...
                                <button type="submit" class="btn btn-danger btn-sm" id="cetak">Cetak Laporan<i class="fas fa-print ml-2" ></i></button>

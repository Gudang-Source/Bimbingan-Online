...
class Pesan extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->templatekaprodi->backend('pesan_v', $data);
	}
	                                ...
	                                <div class="row">
	                                    ...
	                                    <div class="col-6">
	                                        ...
	                                        <div class="col-12 my-2">
	                                            <a href='.site_url('pesan/download/'.$proposal2->NamaFile.'').' class="btn btn-danger btn-sm col-12">Download<i class="fas fa-file-pdf ml-2"></i></a>
	                                        </div>
	                                    </div>
	                                </div>
	                                <p class="h7 text-right text-gray mb-n1">' . format_indo($row->created_at) . '</p>
					...
					<div class="row">
	                    ...
	                    <input type="hidden" name="ProposalID" value='.$proposal['ProposalID'].'>
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="form-group">
	                            	<a href='. site_url('pesan/download/'. $proposal['NamaFile'].'').' class="btn btn-danger btn-sm">Download<i class="fas fa-file-pdf ml-2"></i></a>
	                            </div>
	                        </div>
	                    </div>
	                </div>
	...
	public function form()
	{
		...
		if ($query) {
			...
			foreach ($query as $row) {
				...
				$this->table->add_row($noo, $row->NamaBAB, $row->Keterangan, '<p class="btn btn-info btn-sm">' . $row->Status . '</p>', '<a href=' . site_url('pesan/download/' . $row->NamaFile . '') . ' class="btn btn-danger btn-sm">Download<i class="fas fa-file-pdf ml-2"></i></a>');
			}

...
class Mahasiswa extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array('Mahasiswa_model'=>'mahasiswa'));
	...
	//   $opt = $this->kriteria->as_dropdown('NamaKriteria')->get_all();
		...
		$opt_prodi = array('Teknik Informatika' => 'Teknik Informatika', 'Sistem Informasi' => 'Sistem Informasi');
		...
		$data = array('hidden'=> form_hidden('aksi', !empty($row->NIM) ? 'update' : 'create'),
			...
			'Prodi' => form_dropdown('Prodi', $opt_prodi, !empty($row->Prodi) ? $row->Prodi : '', 'class="form-control chosen-select"'),
	...
	public function save_mahasiswa()
	{
		...
		$rules = array(
			'insert' => array(
				...
				array('field' => 'NIM', 'label' => 'NIM', 'rules' => 'trim|required|is_unique[mahasiswa.NIM]|max_length[20]'),
				array('field' => 'Nama', 'label' => 'Nama', 'rules' => 'trim|required|max_length[150]'),
				array('field' => 'Prodi', 'label' => 'Prodi', 'rules' => 'trim|required|max_length[150]'),

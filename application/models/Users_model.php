...
{
    protected $column_order = array(null, 'id', 'first_name', 'last_name', 'username', 'password', 'email', 'phone', 'created_on', 'last_login');
    protected $column_search = array('id','first_name' , 'last_name', 'username', 'password', 'email', 'phone', 'created_on', 'last_login');

...
class Penelitian_model extends MY_Model
{
    protected $column_order = array(null, 'PenelitianID', 'NIM', 'NPP', 'Jenis', 'Judul', 'Status', 'Info','TahunAkademikID', 'created_at', 'updated_at');
    protected $column_search = array('PenelitianID', 'mahasiswa.NIM', 'NPP','Jenis' ,'Judul', 'tahun_akademik.TahunAkademik', 'penelitian.Status');
    ...
    public function __construct()
    {
        ...
        $this->has_many['proposal'] = array('Proposal_model', 'PenelitianID', 'PenelitianID');
        $this->has_many['sk_penelitian'] = array('Skpenelitian_model', 'PenelitianID', 'PenelitianID');

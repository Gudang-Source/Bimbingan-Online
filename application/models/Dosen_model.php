...
{
    protected $column_order = array(null, 'NPP', 'Nama', 'Jabatan', 'created_at', 'updated_at');
    protected $column_search = array('NPP','Nama' ,'Jabatan', 'created_at', 'updated_at');
    ...
    public function __construct()
    {
        ...
        $this->has_many['penelitian'] = array('Penelitian_model', 'NPP', 'NPP');

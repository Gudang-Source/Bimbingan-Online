...
{
    protected $column_order = array(null, 'ProdiID', 'NamaProdi', 'Jenjang', 'created_at', 'updated_at');
    protected $column_search = array('ProdiID', 'NamaProdi', 'Jenjang', 'created_at', 'updated_at');

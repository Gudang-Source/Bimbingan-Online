...
class Grouppesan_model extends MY_Model
{
    protected $column_order = array(null, 'GroupPesanID', 'Name1', 'Name2', 'created_at', 'updated_at');
    protected $column_search = array('GroupPesanID','Name1' ,'Name2', 'created_at', 'updated_at');
    protected $order = array('GroupPesanID' => 'asc');

    public function __construct()
    {
        $this->table       = 'group_pesan';
        $this->primary_key = 'GroupPesanID';
        $this->fillable    = $this->column_order;
        $this->timestamps  = TRUE;

        // $this->has_one['kriteria'] = array('Kriteria_model', 'KriteriaID', 'KriteriaID');
        $this->has_many['pesan'] = array('Pesan_model', 'GroupPesanID', 'GroupPesanID');
